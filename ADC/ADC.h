...
#define EOC_BIT_POS 10
#define CONT_BIT_POS 1
#define LENGTH_BIT_POS 20


#define ONE_CONVERSION 0x0
#define TWO_CONVERSION 0x1
#define THREE_CONVERSION 0x2
#define FOUR_CONVERSION 0x3
